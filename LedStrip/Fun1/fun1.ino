...
void loop() 
{
  fillEvenOdd(strip.Color(40, 0, 255), strip.Color(0, 255, 255));
  return;
...
void old_loop()
{
  colorSet(strip.Color(39, 0, 255));  // Purple
  colorSet(strip.Color(80, 40, 40));  // Pink
...
void fillAqua(int offset, int d)
{
  int numPixels = strip.numPixels();
  for(int index = 0; index < numPixels; ++index)
  {
    int r = 0;
    float a = (index+offset) / (2*3.14/numPixels);
    int g = 128 + cos(a)*128;
    int b = 128 + sin(a)*128;
